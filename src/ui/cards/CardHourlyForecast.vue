  ...
  <div class="hourly">
    ...
    <div class="hourly__list">
      <ul v-if="getHourlyForecast" class="hourly__items">
        <li v-for="(items, i) in getHourlyForecast" :key="items.id" class="hourly__item">
...
const { getHourlyForecast } = storeToRefs(store);
</script>
<style lang="scss" scoped>@import "@/assets/styles/CardHourlyForecast.scss";</style>